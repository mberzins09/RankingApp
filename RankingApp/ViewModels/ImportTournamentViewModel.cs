...
{
    public partial class ImportTournamentViewModel(TournamentService tournamentService, DatabaseService databaseService, PlayerReposotoryWithDate playerReposotoryWithDate, ApiGameImporterService importer) : BaseViewModel
    {
        private readonly TournamentService _tournamentService = tournamentService;
        private readonly DatabaseService _databaseService = databaseService;
        private readonly PlayerReposotoryWithDate _playerReposotoryWithDate = playerReposotoryWithDate;
        private readonly ApiGameImporterService _importer = importer; 
        private Dictionary<string, List<PlayerDB>> playersCacheByMonth = [];
