...
@application_config = dso_local local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 550, ; uint32_t number_of_dso_cache_entries (0x226)
...
; DSO cache entries
@dso_cache = dso_local local_unnamed_addr global [550 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.89_name, ; name: libaot-netstandard.dll.so
		ptr null; void* handle (0x0)
	}, ; 36
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 1570108528649620503, ; hash 0x15ca256354f8cc17, from name: libaot-RankingApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RankingApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 48
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.77_name, ; name: libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so
		ptr null; void* handle (0x0)
	}, ; 80
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 10067998842245660575, ; hash 0x8bb8b79abf18bf9f, from name: RankingApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RankingApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 296
	...
	%struct.DSOCacheEntry {
		i64 12152700710623012220, ; hash 0xa8a710e89652657c, from name: RankingApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RankingApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 365
	...
	%struct.DSOCacheEntry {
		i64 15674764932005443554, ; hash 0xd987f3a83def37e2, from name: aot-RankingApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RankingApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 472
	%struct.DSOCacheEntry {
		i64 15683082785155807720, ; hash 0xd9a580b3584179e8, from name: aot-RankingApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RankingApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 473
	...
	%struct.DSOCacheEntry {
		i64 17734817861928179259, ; hash 0xf61ebae1e07b563b, from name: libaot-RankingApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RankingApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 524
...
@.env.3 = private unnamed_addr constant [37 x i8] c"fc1b05fb-4af0-4dcd-8f26-66f0ef32a53a\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [27 x i8] c"com.companyname.rankingapp\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [25 x i8] c"libaot-RankingApp.dll.so\00", align 16
...
@.DSOCacheEntry.77_name = private unnamed_addr constant [64 x i8] c"libaot-System.Runtime.InteropServices.RuntimeInformation.dll.so\00", align 16
...
@.DSOCacheEntry.89_name = private unnamed_addr constant [26 x i8] c"libaot-netstandard.dll.so\00", align 16
