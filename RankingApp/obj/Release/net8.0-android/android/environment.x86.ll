...
@dso_cache = dso_local local_unnamed_addr global [550 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1004892572, ; hash 0x3be5719c, from name: aot-RankingApp.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1367078353, ; hash 0x517bf5d1, from name: libaot-RankingApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RankingApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 157
	...
	%struct.DSOCacheEntry {
		i64 1423272946, ; hash 0x54d56bf2, from name: aot-RankingApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RankingApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 172
	...
	%struct.DSOCacheEntry {
		i64 1566812561, ; hash 0x5d63a991, from name: libaot-RankingApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RankingApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 187
	...
	%struct.DSOCacheEntry {
		i64 2290853039, ; hash 0x888ba4af, from name: RankingApp
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RankingApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 286
	...
	%struct.DSOCacheEntry {
		i64 2508513556, ; hash 0x9584e114, from name: RankingApp.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-RankingApp.dll.so
		ptr null; void* handle (0x0)
	}, ; 313
